            ...
            return (
              ...
              >
                <div className="h-24 md:h-36 mb-4 flex items-center justify-center p-4 relative">
                  <Image 
                    src={plate.images?.[0]?.url || 'https://i.ibb.co/SwNbdXCN/Magic-Eraser-260526-160355.png'} 
                    alt={plate.name}
                    width={150}
                    height={150}
                    className={cn(
        ...
        <div className="flex items-center justify-center order-1 md:order-2">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <Image 
                  src={currentPlate.images?.[0]?.url || 'https://i.ibb.co/SwNbdXCN/Magic-Eraser-260526-160355.png'} 
