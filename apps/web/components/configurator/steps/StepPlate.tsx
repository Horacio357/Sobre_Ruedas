...
export default function StepPlate() {
  ...
  const recommended = availablePlates[0];
  const alternatives = availablePlates.slice(1);
    ...
    <div className="space-y-12">
      <div className="text-center mb-16">
        ...
        <p className="text-[#B08B8B] text-base max-w-2xl mx-auto font-light opacity-80 leading-relaxed">
          El chasis de tu patín. Una plancha estable y responsiva es fundamental para transmitir tu fuerza.
        </p>
      </div>
