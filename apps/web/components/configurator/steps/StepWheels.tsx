  ...
  return (    <div className="relative max-w-6xl mx-auto w-full min-h-[700px] flex flex-col items-center py-12 md:py-16 overflow-hidden">
      ...
      <div className="relative z-30 w-full max-w-6xl px-4 mb-12 md:mb-20">
        ...
        <div 
          ref={scrollRef}
          role="list"
          aria-label="Modelos de ruedas disponibles"
          ...
          {availableWheels.map((wheel, i) => {
            ...
            return (
              <motion.button
                ...
                aria-label={`Seleccionar ruedas ${wheel.brand_name} ${wheel.name}`}
                className={cn(
              ...
              >
                <div className="h-24 md:h-36 mb-4 flex items-center justify-center p-4 relative">
                  <Image 
                    src={wheel.images?.[0]?.url || 'https://i.ibb.co/SwNbdXCN/Magic-Eraser-260526-160355.png'} 
                    alt={wheel.name}
                    width={150}
                    height={150}
                    className={cn(
        ...
        <div className="flex items-center justify-center order-1 md:order-2">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <Image 
                  src={currentWheels.images?.[0]?.url || 'https://i.ibb.co/SwNbdXCN/Magic-Eraser-260526-160355.png'} 
